<template>
  <div class="container mt-3">
    <lx-tool-bar>
      <h3>Toolbar Header</h3>
      <button class="btn iconed">
        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="table" role="img"
      ...
      <template #right>
        ...
        <button class="btn iconed">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="th-large" role="img"
               ...
               class="svg-inline--fa fa-th-large fa-w-16 fa-3x">
            <path fill="currentColor"
...
<script>
import {lxToolBar} from "@/entry"

export default {
  name: "Toolbars",
  components: {lxToolBar}
}
</script>
