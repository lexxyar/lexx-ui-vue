<template>
  <div class="search-help" :class="readonly?'readonly':''">
    <lx-input :value="val" :readonly="true">
      <template #append>
        <button class="btn btn-light" @click="readonly?'':show = true">
          <svg focusable="false" data-icon="clone"
               xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="search-help-svg-icon">
