<template>
  <div class="navbar" :class="toggled?'toggled':''">
    ...
    <div class="toggle" :class="toggled?'toggled':''" @click="onToggle">
      ...
      <template v-else>
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="times" role="img"
             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512" class="svg-inline--fa fa-times fa-w-11 fa-3x">
          <path fill="currentColor"
